...
class PresupuestosControllerTest < ActionController::TestCase
  ...
  test "should create presupuesto" do
    assert_difference('Presupuesto.count') do
      post :create, presupuesto: { acabado: @presupuesto.acabado, codigoalg: @presupuesto.codigoalg, series: @presupuesto.series }
    end
  ...
  test "should update presupuesto" do
    patch :update, id: @presupuesto, presupuesto: { acabado: @presupuesto.acabado, codigoalg: @presupuesto.codigoalg, series: @presupuesto.series }
    assert_redirected_to presupuesto_path(assigns(:presupuesto))
  end
